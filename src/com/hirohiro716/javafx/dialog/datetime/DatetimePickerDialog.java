...
public class DatetimePickerDialog extends AbstractDialog<Date> {
    ...
    protected void preparationCallback() {
        ...
        this.getDialogPane().addEventHandler(KeyEvent.KEY_RELEASED, new EventHandler<KeyEvent>() {
            ...
            public void handle(KeyEvent event) {
                ...
                case O:
                    DatetimePickerDialog.this.buttonOk.fire();
                    event.consume();
                    break;
                case C:
                    DatetimePickerDialog.this.buttonCancel.fire();
                    event.consume();
                    break;
                default:
                    break;
     ...
     */
    public static void show(String title, String message, CloseEventHandler<Date> closeEvent) {
     ...
     * @param closeEvent 閉じる際の処理
     */
    public static void show(String title, String message, Stage parentStage, CloseEventHandler<Date> closeEvent) {
        DatetimePickerDialog dialog = new DatetimePickerDialog(parentStage);
        dialog.setTitle(title);
        dialog.setMessage(message);
        dialog.setCloseEvent(closeEvent);
        dialog.show();
